...
from client.combat.solvers.tachyon_prism_solver import TachyonPrismCombatSolver

def test_tachyon_prism_combat_solver_intercept():
    solver = TachyonPrismCombatSolver()
