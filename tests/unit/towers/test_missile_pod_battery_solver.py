...
from client.combat.solvers.missile_pod_battery_solver import MissilePodBatteryCombatSolver

def test_missile_pod_battery_combat_solver_intercept():
    solver = MissilePodBatteryCombatSolver()
