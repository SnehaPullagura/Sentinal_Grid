...
from client.combat.solvers.frostbite_cryo_solver import FrostbiteCryoCombatSolver

def test_frostbite_cryo_combat_solver_intercept():
    solver = FrostbiteCryoCombatSolver()
