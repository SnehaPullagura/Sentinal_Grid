...
from client.combat.solvers.tesla_overcharger_solver import TeslaOverchargerCombatSolver

def test_tesla_overcharger_combat_solver_intercept():
    solver = TeslaOverchargerCombatSolver()
