...
from client.combat.solvers.gauss_accelerator_solver import GaussAcceleratorCombatSolver

def test_gauss_accelerator_combat_solver_intercept():
    solver = GaussAcceleratorCombatSolver()
