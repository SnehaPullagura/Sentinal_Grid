...
from client.combat.solvers.resource_refinery_solver import ResourceRefineryCombatSolver

def test_resource_refinery_combat_solver_intercept():
    solver = ResourceRefineryCombatSolver()
