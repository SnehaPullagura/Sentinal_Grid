...
from client.combat.solvers.quantum_blaster_solver import QuantumBlasterCombatSolver

def test_quantum_blaster_combat_solver_intercept():
    solver = QuantumBlasterCombatSolver()
