...
from client.combat.solvers.chrono_decelerator_solver import ChronoDeceleratorCombatSolver

def test_chrono_decelerator_combat_solver_intercept():
    solver = ChronoDeceleratorCombatSolver()
