...
from client.combat.solvers.kinetic_vulcan_solver import KineticVulcanCombatSolver

def test_kinetic_vulcan_combat_solver_intercept():
    solver = KineticVulcanCombatSolver()
