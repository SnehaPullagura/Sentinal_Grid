...
from client.combat.solvers.arc_discharger_solver import ArcDischargerCombatSolver

def test_arc_discharger_combat_solver_intercept():
    solver = ArcDischargerCombatSolver()
