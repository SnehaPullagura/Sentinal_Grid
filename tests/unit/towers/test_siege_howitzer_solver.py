...
from client.combat.solvers.siege_howitzer_solver import SiegeHowitzerCombatSolver

def test_siege_howitzer_combat_solver_intercept():
    solver = SiegeHowitzerCombatSolver()
