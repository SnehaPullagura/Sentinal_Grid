...
from client.combat.solvers.orbital_uplink_solver import OrbitalUplinkCombatSolver

def test_orbital_uplink_combat_solver_intercept():
    solver = OrbitalUplinkCombatSolver()
