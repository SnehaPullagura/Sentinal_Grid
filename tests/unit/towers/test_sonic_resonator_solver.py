...
from client.combat.solvers.sonic_resonator_solver import SonicResonatorCombatSolver

def test_sonic_resonator_combat_solver_intercept():
    solver = SonicResonatorCombatSolver()
