...
from client.ai.solvers.heavy_colossus_solver import HeavyColossusStrategySolver

def test_heavy_colossus_strategy_solver_evasion():
    solver = HeavyColossusStrategySolver()
