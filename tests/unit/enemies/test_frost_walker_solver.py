...
from client.ai.solvers.frost_walker_solver import FrostWalkerStrategySolver

def test_frost_walker_strategy_solver_evasion():
    solver = FrostWalkerStrategySolver()
