...
from client.ai.solvers.warp_striker_solver import WarpStrikerStrategySolver

def test_warp_striker_strategy_solver_evasion():
    solver = WarpStrikerStrategySolver()
