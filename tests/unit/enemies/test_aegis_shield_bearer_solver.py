...
from client.ai.solvers.aegis_shield_bearer_solver import AegisShieldBearerStrategySolver

def test_aegis_shield_bearer_strategy_solver_evasion():
    solver = AegisShieldBearerStrategySolver()
