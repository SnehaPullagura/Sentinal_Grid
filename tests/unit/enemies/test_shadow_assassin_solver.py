...
from client.ai.solvers.shadow_assassin_solver import ShadowAssassinStrategySolver

def test_shadow_assassin_strategy_solver_evasion():
    solver = ShadowAssassinStrategySolver()
