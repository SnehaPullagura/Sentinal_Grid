...
from client.ai.solvers.vanguard_mech_solver import VanguardMechStrategySolver

def test_vanguard_mech_strategy_solver_evasion():
    solver = VanguardMechStrategySolver()
