...
from client.ai.solvers.siege_breaker_ram_solver import SiegeBreakerRamStrategySolver

def test_siege_breaker_ram_strategy_solver_evasion():
    solver = SiegeBreakerRamStrategySolver()
