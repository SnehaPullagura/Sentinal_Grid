...
from client.ai.solvers.armored_juggernaut_solver import ArmoredJuggernautStrategySolver

def test_armored_juggernaut_strategy_solver_evasion():
    solver = ArmoredJuggernautStrategySolver()
