...
from client.ai.solvers.aero_interceptor_solver import AeroInterceptorStrategySolver

def test_aero_interceptor_strategy_solver_evasion():
    solver = AeroInterceptorStrategySolver()
