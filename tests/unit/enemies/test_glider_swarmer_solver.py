...
from client.ai.solvers.glider_swarmer_solver import GliderSwarmerStrategySolver

def test_glider_swarmer_strategy_solver_evasion():
    solver = GliderSwarmerStrategySolver()
