"""
Enemy Behavioral & Strategic Solver: SCOUT_INFILTRATOR
...
class ScoutInfiltratorStrategySolver:
    def __init__(self):
        self.archetype_id: str = "scout_infiltrator"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "scout_infiltrator".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "scout_infiltrator"),
