"""
Enemy Behavioral & Strategic Solver: CYBER_HIVE_CARRIER
...
class CyberHiveCarrierStrategySolver:
    def __init__(self):
        self.archetype_id: str = "cyber_hive_carrier"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "cyber_hive_carrier".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "cyber_hive_carrier"),
