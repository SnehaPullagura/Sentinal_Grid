"""
Enemy Behavioral & Strategic Solver: NANITE_MEDIC
...
class NaniteMedicStrategySolver:
    def __init__(self):
        self.archetype_id: str = "nanite_medic"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "nanite_medic".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "nanite_medic"),
