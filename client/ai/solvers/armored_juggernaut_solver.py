"""
Enemy Behavioral & Strategic Solver: ARMORED_JUGGERNAUT
...
class ArmoredJuggernautStrategySolver:
    def __init__(self):
        self.archetype_id: str = "armored_juggernaut"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "armored_juggernaut".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "armored_juggernaut"),
