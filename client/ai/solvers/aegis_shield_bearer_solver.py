"""
Enemy Behavioral & Strategic Solver: AEGIS_SHIELD_BEARER
...
class AegisShieldBearerStrategySolver:
    def __init__(self):
        self.archetype_id: str = "aegis_shield_bearer"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "aegis_shield_bearer".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "aegis_shield_bearer"),
