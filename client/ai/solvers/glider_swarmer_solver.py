"""
Enemy Behavioral & Strategic Solver: GLIDER_SWARMER
...
class GliderSwarmerStrategySolver:
    def __init__(self):
        self.archetype_id: str = "glider_swarmer"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "glider_swarmer".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "glider_swarmer"),
