"""
Enemy Behavioral & Strategic Solver: HEAVY_COLOSSUS
...
class HeavyColossusStrategySolver:
    def __init__(self):
        self.archetype_id: str = "heavy_colossus"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "heavy_colossus".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "heavy_colossus"),
