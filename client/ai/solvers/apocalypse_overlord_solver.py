"""
Enemy Behavioral & Strategic Solver: APOCALYPSE_OVERLORD
...
class ApocalypseOverlordStrategySolver:
    def __init__(self):
        self.archetype_id: str = "apocalypse_overlord"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "apocalypse_overlord".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "apocalypse_overlord"),
