"""
Enemy Behavioral & Strategic Solver: HYDRA_BROODMOTHER
...
class HydraBroodmotherStrategySolver:
    def __init__(self):
        self.archetype_id: str = "hydra_broodmother"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "hydra_broodmother".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "hydra_broodmother"),
