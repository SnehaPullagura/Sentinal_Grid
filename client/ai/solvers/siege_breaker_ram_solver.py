"""
Enemy Behavioral & Strategic Solver: SIEGE_BREAKER_RAM
...
class SiegeBreakerRamStrategySolver:
    def __init__(self):
        self.archetype_id: str = "siege_breaker_ram"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "siege_breaker_ram".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "siege_breaker_ram"),
