"""
Enemy Behavioral & Strategic Solver: WARP_STRIKER
...
class WarpStrikerStrategySolver:
    def __init__(self):
        self.archetype_id: str = "warp_striker"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "warp_striker".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "warp_striker"),
