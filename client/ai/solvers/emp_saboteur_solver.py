"""
Enemy Behavioral & Strategic Solver: EMP_SABOTEUR
...
class EmpSaboteurStrategySolver:
    def __init__(self):
        self.archetype_id: str = "emp_saboteur"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "emp_saboteur".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "emp_saboteur"),
