"""
Enemy Behavioral & Strategic Solver: PHANTOM_INFILTRATOR
...
class PhantomInfiltratorStrategySolver:
    def __init__(self):
        self.archetype_id: str = "phantom_infiltrator"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "phantom_infiltrator".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "phantom_infiltrator"),
