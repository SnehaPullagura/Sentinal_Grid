"""
Enemy Behavioral & Strategic Solver: AERO_INTERCEPTOR
...
class AeroInterceptorStrategySolver:
    def __init__(self):
        self.archetype_id: str = "aero_interceptor"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "aero_interceptor".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "aero_interceptor"),
