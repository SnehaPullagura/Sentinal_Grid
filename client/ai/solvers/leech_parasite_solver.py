"""
Enemy Behavioral & Strategic Solver: LEECH_PARASITE
...
class LeechParasiteStrategySolver:
    def __init__(self):
        self.archetype_id: str = "leech_parasite"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "leech_parasite".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "leech_parasite"),
