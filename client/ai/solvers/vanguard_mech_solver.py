"""
Enemy Behavioral & Strategic Solver: VANGUARD_MECH
...
class VanguardMechStrategySolver:
    def __init__(self):
        self.archetype_id: str = "vanguard_mech"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "vanguard_mech".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "vanguard_mech"),
