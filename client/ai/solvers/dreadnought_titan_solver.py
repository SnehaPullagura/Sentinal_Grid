"""
Enemy Behavioral & Strategic Solver: DREADNOUGHT_TITAN
...
class DreadnoughtTitanStrategySolver:
    def __init__(self):
        self.archetype_id: str = "dreadnought_titan"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "dreadnought_titan".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "dreadnought_titan"),
