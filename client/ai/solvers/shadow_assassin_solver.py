"""
Enemy Behavioral & Strategic Solver: SHADOW_ASSASSIN
...
class ShadowAssassinStrategySolver:
    def __init__(self):
        self.archetype_id: str = "shadow_assassin"
    ...
    def evaluate_threats(
        ...
        return EvasionDecision(
            ...
            should_cloak=(current_hp_pct < 0.4 and "shadow_assassin".startswith("phantom")),
            should_shield=(current_hp_pct < 0.8 and "shield" in "shadow_assassin"),
