"""
AI Tactic Behavior: DecoyDistractionTactic
Sends fast cheap swarms ahead to soak heavy single-target railgun shots
"""
...
class DecoyDistractionTactic(BehaviorNode):
