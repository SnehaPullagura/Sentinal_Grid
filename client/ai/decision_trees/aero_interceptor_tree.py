"""
AI Decision Tree & Tactical Subsystem: AERO_INTERCEPTOR
...
@dataclass
class AeroInterceptorPerception:
...
class AeroInterceptorAITree:
    def __init__(self, owner_id: str):
        self.owner_id: str = owner_id
        self.perception: AeroInterceptorPerception = AeroInterceptorPerception()
