"""
AI Decision Tree & Tactical Subsystem: VANGUARD_MECH
...
class VanguardMechAITree:
    def __init__(self, owner_id: str):
        self.owner_id: str = owner_id
        self.perception: VanguardMechPerception = VanguardMechPerception()
