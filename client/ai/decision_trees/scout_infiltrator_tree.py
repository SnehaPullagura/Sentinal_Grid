"""
AI Decision Tree & Tactical Subsystem: SCOUT_INFILTRATOR
...
@dataclass
class ScoutInfiltratorPerception:
...
class ScoutInfiltratorAITree:
    def __init__(self, owner_id: str):
        self.owner_id: str = owner_id
        self.perception: ScoutInfiltratorPerception = ScoutInfiltratorPerception()
