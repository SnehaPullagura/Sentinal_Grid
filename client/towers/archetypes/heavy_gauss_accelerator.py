"""
Production Tower Implementation: HeavyGaussAccelerator
Archetype: KINETIC | Cost: 240 | Base Damage: 120.0 | Rate: 0.6/s | Range: 210.0
Description: Electromagnetic coilgun launching hypersonic tungsten slugs
"""
...
@dataclass
class HeavyGaussAcceleratorState:
    current_level: int = 1
...
class HeavyGaussAccelerator:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: HeavyGaussAcceleratorState = HeavyGaussAcceleratorState()
