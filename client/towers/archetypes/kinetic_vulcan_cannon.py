"""
Production Tower Implementation: KineticVulcanCannon
Archetype: KINETIC | Cost: 120 | Base Damage: 18.0 | Rate: 4.5/s | Range: 110.0
Description: Rotary 6-barrel kinetic machine cannon with spool-up fire rate mechanics
"""
...
@dataclass
class KineticVulcanCannonState:
    current_level: int = 1
...
class KineticVulcanCannon:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: KineticVulcanCannonState = KineticVulcanCannonState()
