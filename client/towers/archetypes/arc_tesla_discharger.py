"""
Production Tower Implementation: ArcTeslaDischarger
Archetype: ENERGY | Cost: 210 | Base Damage: 45.0 | Rate: 1.0/s | Range: 130.0
Description: High-voltage Tesla coil chaining electricity across multiple targets
"""
...
class ArcTeslaDischarger:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: ArcTeslaDischargerState = ArcTeslaDischargerState()
