"""
Production Tower Implementation: TachyonBeamPrism
Archetype: ENERGY | Cost: 175 | Base Damage: 34.0 | Rate: 2.2/s | Range: 140.0
Description: Continuous photon accelerator delivering melting thermal energy
"""
...
class TachyonBeamPrism:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: TachyonBeamPrismState = TachyonBeamPrismState()
