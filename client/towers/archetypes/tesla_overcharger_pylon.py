"""
Production Tower Implementation: TeslaOverchargerPylon
Archetype: SUPPORT | Cost: 220 | Base Damage: 0.0 | Rate: 0.0/s | Range: 150.0
Description: Superconductive power transmitter augmenting adjacent energy tower fire rate
"""
...
@dataclass
class TeslaOverchargerPylonState:
    current_level: int = 1
...
class TeslaOverchargerPylon:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: TeslaOverchargerPylonState = TeslaOverchargerPylonState()
