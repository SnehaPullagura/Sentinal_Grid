"""
Production Tower Implementation: HeavyPlasmaMortar
Archetype: EXPERIMENTAL | Cost: 310 | Base Damage: 95.0 | Rate: 0.5/s | Range: 175.0
Description: Superheated ionized gas mortar leaving burning thermal residue
"""
...
class HeavyPlasmaMortar:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: HeavyPlasmaMortarState = HeavyPlasmaMortarState()
