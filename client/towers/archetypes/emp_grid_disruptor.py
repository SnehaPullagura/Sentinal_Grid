"""
Production Tower Implementation: EMPGridDisruptor
Archetype: CONTROL | Cost: 195 | Base Damage: 20.0 | Rate: 0.8/s | Range: 100.0
Description: Electromagnetic pulse emitter nullifying enemy forcefields and abilities
"""
...
class EMPGridDisruptor:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: EMPGridDisruptorState = EMPGridDisruptorState()
