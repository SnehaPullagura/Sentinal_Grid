"""
Production Tower Implementation: SonicConcussionCannon
Archetype: CONTROL | Cost: 180 | Base Damage: 22.0 | Rate: 1.2/s | Range: 95.0
Description: Focused directional acoustic shockwave physically pushing hostiles back
"""
...
@dataclass
class SonicConcussionCannonState:
    current_level: int = 1
...
class SonicConcussionCannon:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: SonicConcussionCannonState = SonicConcussionCannonState()
