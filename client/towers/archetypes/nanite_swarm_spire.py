"""
Production Tower Implementation: NaniteSwarmSpire
Archetype: EXPERIMENTAL | Cost: 290 | Base Damage: 50.0 | Rate: 1.5/s | Range: 125.0
Description: Microscopic drone swarm devouring biological and metallic armor
"""
...
class NaniteSwarmSpire:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: NaniteSwarmSpireState = NaniteSwarmSpireState()
