"""
Production Tower Implementation: AegisDefenseMatrix
Archetype: SUPPORT | Cost: 240 | Base Damage: 0.0 | Rate: 0.0/s | Range: 160.0
Description: Defensive forcefield pylon projecting protective energy barriers around towers
"""
...
class AegisDefenseMatrix:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: AegisDefenseMatrixState = AegisDefenseMatrixState()
