"""
Production Tower Implementation: OrbitalCommandUplink
Archetype: SUPPORT | Cost: 250 | Base Damage: 0.0 | Rate: 0.0/s | Range: 180.0
Description: Orbital satellite transmitter boosting adjacent tower attack power
"""
...
@dataclass
class OrbitalCommandUplinkState:
    current_level: int = 1
...
class OrbitalCommandUplink:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        ...
        self.state: OrbitalCommandUplinkState = OrbitalCommandUplinkState()
