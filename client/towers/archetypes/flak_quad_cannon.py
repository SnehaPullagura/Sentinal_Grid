"""
Production Tower Implementation: FlakQuadCannon
Archetype: KINETIC | Cost: 160 | Base Damage: 40.0 | Rate: 2.8/s | Range: 160.0
Description: Quad-barrel anti-air battery detonating proximity fragmentation airbursts
"""
...
class FlakQuadCannon:
    def __init__(self, position: Vector2D, tower_id: Optional[str] = None):
        self.tower_id: str = tower_id or f"flak_quad_cannon_{id(self)}"
        ...
        self.state: FlakQuadCannonState = FlakQuadCannonState()
