"""
Combat Simulation Solver: CHRONO_DECELERATOR
...
class ChronoDeceleratorCombatSolver:
    def __init__(self):
        self.projectile_speed: float = 450.0 if "chrono_decelerator" != "tachyon_prism" else 9999.0
