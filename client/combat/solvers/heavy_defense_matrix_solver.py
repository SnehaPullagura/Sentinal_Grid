"""
Combat Simulation Solver: HEAVY_DEFENSE_MATRIX
...
class HeavyDefenseMatrixCombatSolver:
    def __init__(self):
        self.projectile_speed: float = 450.0 if "heavy_defense_matrix" != "tachyon_prism" else 9999.0
