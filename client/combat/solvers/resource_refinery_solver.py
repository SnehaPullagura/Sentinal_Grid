"""
Combat Simulation Solver: RESOURCE_REFINERY
...
class ResourceRefineryCombatSolver:
    def __init__(self):
        self.projectile_speed: float = 450.0 if "resource_refinery" != "tachyon_prism" else 9999.0
