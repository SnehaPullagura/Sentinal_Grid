"""
Combat Simulation Solver: GAUSS_ACCELERATOR
...
class GaussAcceleratorCombatSolver:
    def __init__(self):
        self.projectile_speed: float = 450.0 if "gauss_accelerator" != "tachyon_prism" else 9999.0
