"""
Combat Simulation Solver: TESLA_OVERCHARGER
...
class TeslaOverchargerCombatSolver:
    def __init__(self):
        self.projectile_speed: float = 450.0 if "tesla_overcharger" != "tachyon_prism" else 9999.0
