"""
Combat Simulation Solver: SINGULARITY_TRAP
...
class SingularityTrapCombatSolver:
    def __init__(self):
        self.projectile_speed: float = 450.0 if "singularity_trap" != "tachyon_prism" else 9999.0
