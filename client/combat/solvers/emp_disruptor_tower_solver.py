"""
Combat Simulation Solver: EMP_DISRUPTOR_TOWER
...
class EmpDisruptorTowerCombatSolver:
    def __init__(self):
        self.projectile_speed: float = 450.0 if "emp_disruptor_tower" != "tachyon_prism" else 9999.0
