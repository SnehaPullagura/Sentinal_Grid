"""
Penetration & Kinetic Ricochet Solver: ARC_DISCHARGER
"""
...
class ArcDischargerPenetrationSolver:
    def __init__(self):
        self.tower_id: str = "arc_discharger"
        self.nominal_caliber_mm: float = 32.7
        self.hardness_rating_hrc: float = 55.0
