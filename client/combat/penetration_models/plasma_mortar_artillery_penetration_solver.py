"""
Penetration & Kinetic Ricochet Solver: PLASMA_MORTAR_ARTILLERY
"""
...
class PlasmaMortarArtilleryPenetrationSolver:
    def __init__(self):
        self.tower_id: str = "plasma_mortar_artillery"
        self.nominal_caliber_mm: float = 60.7
        self.hardness_rating_hrc: float = 61.0
