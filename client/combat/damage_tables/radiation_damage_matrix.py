"""
Combat Damage Matrix Table: RADIATION
...
@dataclass
class RadiationDamageProfile:
    damage_type: str = "radiation"
    ...
    def get_effectiveness_against(self, armor_class: str) -> float:
        matrix: Dict[str, float] = {
            "unarmored": 1.25,
            "light_kevlar": 1.10,
            "heavy_plating": 0.75 if "radiation" == "kinetic" else 1.20,
            "reactive_composite": 0.85,
            "energy_shield": 0.50 if "radiation" == "kinetic" else 1.50,
            "phase_barrier": 0.60 if "radiation" != "quantum" else 2.00,
            "nanite_mesh": 0.90,
