"""
Combat Damage Matrix Table: QUANTUM
...
@dataclass
class QuantumDamageProfile:
    damage_type: str = "quantum"
    ...
    def get_effectiveness_against(self, armor_class: str) -> float:
        matrix: Dict[str, float] = {
            "unarmored": 1.25,
            "light_kevlar": 1.10,
            "heavy_plating": 0.75 if "quantum" == "kinetic" else 1.20,
            "reactive_composite": 0.85,
            "energy_shield": 0.50 if "quantum" == "kinetic" else 1.50,
            "phase_barrier": 0.60 if "quantum" != "quantum" else 2.00,
            "nanite_mesh": 0.90,
