"""
Thermal Dissipation & Overheat Penalty Engine: HEAVY_DEFENSE_MATRIX
"""
...
class HeavyDefenseMatrixThermalEngine:
    def __init__(self):
        self.tower_id: str = "heavy_defense_matrix"
        self.max_temp_c: float = 230.0
        self.heat_per_shot_c: float = 8.5
