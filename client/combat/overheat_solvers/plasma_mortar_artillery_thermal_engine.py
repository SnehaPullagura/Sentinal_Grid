"""
Thermal Dissipation & Overheat Penalty Engine: PLASMA_MORTAR_ARTILLERY
"""
...
class PlasmaMortarArtilleryThermalEngine:
    def __init__(self):
        self.tower_id: str = "plasma_mortar_artillery"
        self.max_temp_c: float = 190.0
        self.heat_per_shot_c: float = 4.0
