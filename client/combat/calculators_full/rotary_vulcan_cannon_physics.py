"""
Weapon Physics & Ballistic Kinematics Engine: RotaryVulcanCannon
"""
...
class RotaryVulcanCannonPhysicsEngine:
    def __init__(self):
        self.weapon_id: str = "rotary_vulcan_cannon"
        self.base_damage: float = 18.0
        self.muzzle_velocity: float = 450.0
        self.base_penetration: float = 0.15
        self.firing_fx: str = "high_rpm"
