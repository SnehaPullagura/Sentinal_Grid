"""
Combat Matchup & Tactical Evaluation Engine: SINGULARITY_TRAP
...
class SingularityTrapMatchupMatrix:
    def __init__(self):
        self.tower_id: str = "singularity_trap"
        self.base_damage: float = 65.0
    ...
    def _build_matchup_database(self) -> Dict[str, MatchupEvaluation]:
        enemies = [
            ...
            ("aero_interceptor", 95.0, 0.0, 0.0, "DISFAVORED" if "singularity_trap" != "flak_anti_air" else "FAVORED", "High altitude tracking required"),
        ...
        for eid, hp, sh, arm, rating, pos_hint in enemies:
            ...
            db[eid] = MatchupEvaluation(
                ...
                elemental_synergy="Thermal Shock + Cryo" if "singularity_trap".startswith("plasma") else "Standard Kinetic Burst"
            )
        return db
