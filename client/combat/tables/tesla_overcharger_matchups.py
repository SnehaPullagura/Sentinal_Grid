"""
Combat Matchup & Tactical Evaluation Engine: TESLA_OVERCHARGER
...
class TeslaOverchargerMatchupMatrix:
    def __init__(self):
        self.tower_id: str = "tesla_overcharger"
        self.base_damage: float = 105.0
    ...
    def _build_matchup_database(self) -> Dict[str, MatchupEvaluation]:
        enemies = [
            ...
            ("aero_interceptor", 95.0, 0.0, 0.0, "DISFAVORED" if "tesla_overcharger" != "flak_anti_air" else "FAVORED", "High altitude tracking required"),
        ...
        for eid, hp, sh, arm, rating, pos_hint in enemies:
            ...
            db[eid] = MatchupEvaluation(
                ...
                elemental_synergy="Thermal Shock + Cryo" if "tesla_overcharger".startswith("plasma") else "Standard Kinetic Burst"
            )
        return db
