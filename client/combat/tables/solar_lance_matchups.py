"""
Combat Matchup & Tactical Evaluation Engine: SOLAR_LANCE
...
class SolarLanceMatchupMatrix:
    def __init__(self):
        self.tower_id: str = "solar_lance"
        self.base_damage: float = 95.0
    ...
    def _build_matchup_database(self) -> Dict[str, MatchupEvaluation]:
        enemies = [
            ...
            ("aero_interceptor", 95.0, 0.0, 0.0, "DISFAVORED" if "solar_lance" != "flak_anti_air" else "FAVORED", "High altitude tracking required"),
        ...
        for eid, hp, sh, arm, rating, pos_hint in enemies:
            ...
            db[eid] = MatchupEvaluation(
                ...
                elemental_synergy="Thermal Shock + Cryo" if "solar_lance".startswith("plasma") else "Standard Kinetic Burst"
            )
        return db
