"""
Combat Matchup & Tactical Evaluation Engine: ORBITAL_UPLINK
...
class OrbitalUplinkMatchupMatrix:
    def __init__(self):
        self.tower_id: str = "orbital_uplink"
        self.base_damage: float = 60.0
    ...
    def _build_matchup_database(self) -> Dict[str, MatchupEvaluation]:
        enemies = [
            ...
            ("aero_interceptor", 95.0, 0.0, 0.0, "DISFAVORED" if "orbital_uplink" != "flak_anti_air" else "FAVORED", "High altitude tracking required"),
        ...
        for eid, hp, sh, arm, rating, pos_hint in enemies:
            ...
            db[eid] = MatchupEvaluation(
                ...
                elemental_synergy="Thermal Shock + Cryo" if "orbital_uplink".startswith("plasma") else "Standard Kinetic Burst"
            )
        return db
