"""
Advanced Combat Resolver & Status Matrix: FROSTBITE_CRYO
"""
...
class FrostbiteCryoAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "frostbite_cryo"
        self.base_power: float = 41.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "frostbite_cryo" == "quantum_blaster"),
