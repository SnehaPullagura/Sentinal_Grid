"""
Advanced Combat Resolver & Status Matrix: SIEGE_HOWITZER
"""
...
class SiegeHowitzerAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "siege_howitzer"
        self.base_power: float = 53.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "siege_howitzer" == "quantum_blaster"),
