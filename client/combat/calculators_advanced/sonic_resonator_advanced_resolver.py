"""
Advanced Combat Resolver & Status Matrix: SONIC_RESONATOR
"""
...
class SonicResonatorAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "sonic_resonator"
        self.base_power: float = 89.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "sonic_resonator" == "quantum_blaster"),
