"""
Advanced Combat Resolver & Status Matrix: MISSILE_POD_BATTERY
"""
...
class MissilePodBatteryAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "missile_pod_battery"
        self.base_power: float = 97.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "missile_pod_battery" == "quantum_blaster"),
