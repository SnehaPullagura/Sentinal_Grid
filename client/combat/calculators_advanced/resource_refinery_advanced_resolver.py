"""
Advanced Combat Resolver & Status Matrix: RESOURCE_REFINERY
"""
...
class ResourceRefineryAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "resource_refinery"
        self.base_power: float = 81.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "resource_refinery" == "quantum_blaster"),
