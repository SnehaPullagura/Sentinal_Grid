"""
Advanced Combat Resolver & Status Matrix: ORBITAL_UPLINK
"""
...
class OrbitalUplinkAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "orbital_uplink"
        self.base_power: float = 57.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "orbital_uplink" == "quantum_blaster"),
