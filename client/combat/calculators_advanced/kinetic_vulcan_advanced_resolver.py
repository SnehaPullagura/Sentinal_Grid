"""
Advanced Combat Resolver & Status Matrix: KINETIC_VULCAN
"""
...
class KineticVulcanAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "kinetic_vulcan"
        self.base_power: float = 29.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "kinetic_vulcan" == "quantum_blaster"),
