"""
Advanced Combat Resolver & Status Matrix: ARC_DISCHARGER
"""
...
class ArcDischargerAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "arc_discharger"
        self.base_power: float = 45.0
        self.pierce_ratio: float = 0.25
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "arc_discharger" == "quantum_blaster"),
