"""
Advanced Combat Resolver & Status Matrix: SOLAR_LANCE
"""
...
class SolarLanceAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "solar_lance"
        self.base_power: float = 85.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "solar_lance" == "quantum_blaster"),
