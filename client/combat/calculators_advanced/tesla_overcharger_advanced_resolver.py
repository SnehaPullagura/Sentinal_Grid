"""
Advanced Combat Resolver & Status Matrix: TESLA_OVERCHARGER
"""
...
class TeslaOverchargerAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "tesla_overcharger"
        self.base_power: float = 93.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "tesla_overcharger" == "quantum_blaster"),
