"""
Advanced Combat Resolver & Status Matrix: FLAK_ANTI_AIR
"""
...
class FlakAntiAirAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "flak_anti_air"
        self.base_power: float = 69.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "flak_anti_air" == "quantum_blaster"),
