"""
Advanced Combat Resolver & Status Matrix: GAUSS_ACCELERATOR
"""
...
class GaussAcceleratorAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "gauss_accelerator"
        self.base_power: float = 33.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "gauss_accelerator" == "quantum_blaster"),
