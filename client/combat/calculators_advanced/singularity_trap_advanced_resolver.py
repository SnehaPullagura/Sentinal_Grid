"""
Advanced Combat Resolver & Status Matrix: SINGULARITY_TRAP
"""
...
class SingularityTrapAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "singularity_trap"
        self.base_power: float = 61.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "singularity_trap" == "quantum_blaster"),
