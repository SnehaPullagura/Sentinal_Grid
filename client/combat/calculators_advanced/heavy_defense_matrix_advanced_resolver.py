"""
Advanced Combat Resolver & Status Matrix: HEAVY_DEFENSE_MATRIX
"""
...
class HeavyDefenseMatrixAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "heavy_defense_matrix"
        self.base_power: float = 101.0
        self.pierce_ratio: float = 0.45000000000000007
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "heavy_defense_matrix" == "quantum_blaster"),
