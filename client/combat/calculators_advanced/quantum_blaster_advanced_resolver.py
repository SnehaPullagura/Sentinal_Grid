"""
Advanced Combat Resolver & Status Matrix: QUANTUM_BLASTER
"""
...
class QuantumBlasterAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "quantum_blaster"
        self.base_power: float = 105.0
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "quantum_blaster" == "quantum_blaster"),
