"""
Advanced Combat Resolver & Status Matrix: PLASMA_MORTAR_ARTILLERY
"""
...
class PlasmaMortarArtilleryAdvancedResolver:
    def __init__(self):
        self.tower_id: str = "plasma_mortar_artillery"
        self.base_power: float = 73.0
        self.pierce_ratio: float = 0.15
    ...
    def resolve_combat_strike(
        ...
        return AdvancedCombatResolution(
            ...
            shield_pierced=(target_shield <= 0.0 or "plasma_mortar_artillery" == "quantum_blaster"),
