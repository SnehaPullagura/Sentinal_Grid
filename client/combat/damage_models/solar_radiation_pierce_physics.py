"""
Damage Physics & Molecular Mitigation Model: SOLAR_RADIATION_PIERCE
...
class SolarRadiationPiercePhysicsModel:
    def __init__(self):
        self.damage_type: str = "solar_radiation_pierce"
