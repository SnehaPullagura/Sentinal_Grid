"""
Damage Physics & Molecular Mitigation Model: ORBITAL_PARTICLE_LANCE
...
class OrbitalParticleLancePhysicsModel:
    def __init__(self):
        self.damage_type: str = "orbital_particle_lance"
