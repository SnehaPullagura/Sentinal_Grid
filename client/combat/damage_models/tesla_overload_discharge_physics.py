"""
Damage Physics & Molecular Mitigation Model: TESLA_OVERLOAD_DISCHARGE
...
class TeslaOverloadDischargePhysicsModel:
    def __init__(self):
        self.damage_type: str = "tesla_overload_discharge"
