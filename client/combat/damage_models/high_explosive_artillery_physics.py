"""
Damage Physics & Molecular Mitigation Model: HIGH_EXPLOSIVE_ARTILLERY
...
class HighExplosiveArtilleryPhysicsModel:
    def __init__(self):
        self.damage_type: str = "high_explosive_artillery"
