"""
Damage Physics & Molecular Mitigation Model: GUIDED_MISSILE_FRAGMENTATION
...
class GuidedMissileFragmentationPhysicsModel:
    def __init__(self):
        self.damage_type: str = "guided_missile_fragmentation"
