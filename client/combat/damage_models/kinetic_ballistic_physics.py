"""
Damage Physics & Molecular Mitigation Model: KINETIC_BALLISTIC
...
class KineticBallisticPhysicsModel:
    def __init__(self):
        self.damage_type: str = "kinetic_ballistic"
