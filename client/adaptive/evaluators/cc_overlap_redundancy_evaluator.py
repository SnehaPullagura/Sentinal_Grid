"""
Adaptive Engine Evaluator: CCOverlapRedundancyEvaluator
Calculates wasted slow/freeze debuff overlap to trigger fast resistance swarms
"""
...
class CCOverlapRedundancyEvaluator:
    def __init__(self):
