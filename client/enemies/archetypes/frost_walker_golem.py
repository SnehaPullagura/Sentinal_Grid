"""
Production Enemy Implementation: FrostWalkerGolem
Archetype: BASIC | HP: 220.0 | Shield: 0.0 | Armor: 8.0 | Speed: 55.0 | Flying: False
Description: Sub-zero elemental golem completely immune to Cryo slowing fields
"""
...
class FrostWalkerGolem:
    def __init__(self, spawn_pos: Vector2D, enemy_id: Optional[str] = None):
        ...
        self.state: FrostWalkerGolemState = FrostWalkerGolemState()
