"""
Production Enemy Implementation: LeechParasiteVampire
Archetype: SWARM | HP: 40.0 | Shield: 0.0 | Armor: 0.0 | Speed: 95.0 | Flying: False
Description: Resource-draining parasite siphoning player credits on leak
"""
...
class LeechParasiteVampire:
    def __init__(self, spawn_pos: Vector2D, enemy_id: Optional[str] = None):
        ...
        self.state: LeechParasiteVampireState = LeechParasiteVampireState()
