"""
Deep Tech Tree Progression Engine: ARMOR
Handles multi-branch dependency graphs, point costs, statistical scaling,
and active tactical perks for all 20 tiers of armor research.
"""
...
class ArmorDeepResearchEngine:
    def __init__(self):
        self.branch_name: str = "armor"
