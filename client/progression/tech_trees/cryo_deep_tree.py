"""
Deep Tech Tree Progression Engine: CRYO
Handles multi-branch dependency graphs, point costs, statistical scaling,
and active tactical perks for all 20 tiers of cryo research.
"""
...
class CryoDeepResearchEngine:
    def __init__(self):
        self.branch_name: str = "cryo"
