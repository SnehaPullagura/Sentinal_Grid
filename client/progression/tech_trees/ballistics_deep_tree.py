"""
Deep Tech Tree Progression Engine: BALLISTICS
Handles multi-branch dependency graphs, point costs, statistical scaling,
and active tactical perks for all 20 tiers of ballistics research.
"""
...
class BallisticsDeepResearchEngine:
    def __init__(self):
        self.branch_name: str = "ballistics"
