"""
Tactical Command Briefing Dialogue: Sector 06
"""
...
class Sector06Dialogue:
    @staticmethod
    def get_briefing() -> List[DialogueLine]:
        return [
            DialogueLine("Commander Vance", "Sentinel Grid deployed in Sector 06. Hostile signatures detected on long-range radar."),
    ...
    def get_victory_debrief() -> List[DialogueLine]:
        return [
            DialogueLine("Tactical AI (Aegis)", "Hostile signatures eliminated. Sector 06 secured with zero critical breaches."),
