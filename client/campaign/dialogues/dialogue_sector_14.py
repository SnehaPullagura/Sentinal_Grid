"""
Tactical Command Briefing Dialogue: Sector 14
"""
...
class Sector14Dialogue:
    @staticmethod
    def get_briefing() -> List[DialogueLine]:
        return [
            DialogueLine("Commander Vance", "Sentinel Grid deployed in Sector 14. Hostile signatures detected on long-range radar."),
    ...
    def get_victory_debrief() -> List[DialogueLine]:
        return [
            DialogueLine("Tactical AI (Aegis)", "Hostile signatures eliminated. Sector 14 secured with zero critical breaches."),
