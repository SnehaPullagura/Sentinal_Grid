"""
Sentinel Grid Challenge Rule: One Life Shield
Any single enemy leaking results in immediate defeat
"""
...
class ChallengeModifiers:
    challenge_id: str = "challenge_sudden_death"
    title: str = "One Life Shield"
    description: str = "Any single enemy leaking results in immediate defeat"
