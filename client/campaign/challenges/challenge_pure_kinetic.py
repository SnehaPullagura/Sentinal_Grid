"""
Sentinel Grid Challenge Rule: Iron Age Doctrine
Energy and Experimental towers are forbidden
"""
...
class ChallengeModifiers:
    challenge_id: str = "challenge_pure_kinetic"
    title: str = "Iron Age Doctrine"
    description: str = "Energy and Experimental towers are forbidden"
