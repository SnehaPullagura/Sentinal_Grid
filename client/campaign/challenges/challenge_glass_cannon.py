"""
Sentinel Grid Challenge Rule: Fragile Armaments
Towers deal 200% damage but base has only 10 HP
"""
...
class ChallengeModifiers:
    challenge_id: str = "challenge_glass_cannon"
    title: str = "Fragile Armaments"
    description: str = "Towers deal 200% damage but base has only 10 HP"
