"""
Sentinel Grid Challenge Rule: Cryo Sub-Zero
Enemies have 80% slow resistance but freeze deals 3x DoT
"""
...
class ChallengeModifiers:
    challenge_id: str = "challenge_extreme_cc"
    title: str = "Cryo Sub-Zero"
    description: str = "Enemies have 80% slow resistance but freeze deals 3x DoT"
