"""
Sentinel Grid Challenge Rule: Plasma Matrix
Kinetic towers are disabled; all shields doubled
"""
...
class ChallengeModifiers:
    challenge_id: str = "challenge_pure_energy"
    title: str = "Plasma Matrix"
    description: str = "Kinetic towers are disabled; all shields doubled"
