"""
Sentinel Grid Challenge Rule: Titan Vanguard
Every wave contains an enraged Boss unit
"""
...
class ChallengeModifiers:
    challenge_id: str = "challenge_boss_onslaught"
    title: str = "Titan Vanguard"
    description: str = "Every wave contains an enraged Boss unit"
