"""
Sentinel Grid Challenge Rule: Radar Blindspot
Tower detection range reduced by 40%
"""
...
class ChallengeModifiers:
    challenge_id: str = "challenge_fog_of_war"
    title: str = "Radar Blindspot"
    description: str = "Tower detection range reduced by 40%"
