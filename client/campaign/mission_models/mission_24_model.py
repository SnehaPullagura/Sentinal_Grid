"""
Campaign Mission Model 24: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission24DataModel:
    def __init__(self):
        self.mission_index: int = 24
        self.sector_name: str = "Tactical Sector 24 - Iron Outpost"
        self.world_tier: int = 5
        self.base_starting_credits: int = 880
        self.base_starting_energy: int = 220
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 35):
            threat = round(20.0 + w * 12.5 + 24 * 3.5, 1)
            spawns = [
