"""
Campaign Mission Model 20: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission20DataModel:
    def __init__(self):
        self.mission_index: int = 20
        self.sector_name: str = "Tactical Sector 20 - Iron Outpost"
        self.world_tier: int = 4
        self.base_starting_credits: int = 800
        self.base_starting_energy: int = 200
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 31):
            threat = round(20.0 + w * 12.5 + 20 * 3.5, 1)
            spawns = [
