"""
Campaign Mission Model 19: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission19DataModel:
    def __init__(self):
        self.mission_index: int = 19
        self.sector_name: str = "Tactical Sector 19 - Iron Outpost"
        self.world_tier: int = 4
        self.base_starting_credits: int = 780
        self.base_starting_energy: int = 195
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 30):
            threat = round(20.0 + w * 12.5 + 19 * 3.5, 1)
            spawns = [
