"""
Campaign Mission Model 11: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission11DataModel:
    def __init__(self):
        self.mission_index: int = 11
        self.sector_name: str = "Tactical Sector 11 - Iron Outpost"
        self.world_tier: int = 3
        self.base_starting_credits: int = 620
        self.base_starting_energy: int = 155
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 22):
            threat = round(20.0 + w * 12.5 + 11 * 3.5, 1)
            spawns = [
