"""
Campaign Mission Model 13: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission13DataModel:
    def __init__(self):
        self.mission_index: int = 13
        self.sector_name: str = "Tactical Sector 13 - Iron Outpost"
        self.world_tier: int = 3
        self.base_starting_credits: int = 660
        self.base_starting_energy: int = 165
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 24):
            threat = round(20.0 + w * 12.5 + 13 * 3.5, 1)
            spawns = [
