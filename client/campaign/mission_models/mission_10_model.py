"""
Campaign Mission Model 10: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission10DataModel:
    def __init__(self):
        self.mission_index: int = 10
        self.sector_name: str = "Tactical Sector 10 - Iron Outpost"
        self.world_tier: int = 2
        self.base_starting_credits: int = 600
        self.base_starting_energy: int = 150
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 21):
            threat = round(20.0 + w * 12.5 + 10 * 3.5, 1)
            spawns = [
