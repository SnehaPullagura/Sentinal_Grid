"""
Campaign Mission Model 18: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission18DataModel:
    def __init__(self):
        self.mission_index: int = 18
        self.sector_name: str = "Tactical Sector 18 - Iron Outpost"
        self.world_tier: int = 4
        self.base_starting_credits: int = 760
        self.base_starting_energy: int = 190
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 29):
            threat = round(20.0 + w * 12.5 + 18 * 3.5, 1)
            spawns = [
