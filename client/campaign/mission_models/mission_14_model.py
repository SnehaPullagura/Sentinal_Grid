"""
Campaign Mission Model 14: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission14DataModel:
    def __init__(self):
        self.mission_index: int = 14
        self.sector_name: str = "Tactical Sector 14 - Iron Outpost"
        self.world_tier: int = 3
        self.base_starting_credits: int = 680
        self.base_starting_energy: int = 170
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 25):
            threat = round(20.0 + w * 12.5 + 14 * 3.5, 1)
            spawns = [
