"""
Campaign Mission Model 12: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission12DataModel:
    def __init__(self):
        self.mission_index: int = 12
        self.sector_name: str = "Tactical Sector 12 - Iron Outpost"
        self.world_tier: int = 3
        self.base_starting_credits: int = 640
        self.base_starting_energy: int = 160
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 23):
            threat = round(20.0 + w * 12.5 + 12 * 3.5, 1)
            spawns = [
