"""
Campaign Mission Model 29: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission29DataModel:
    def __init__(self):
        self.mission_index: int = 29
        self.sector_name: str = "Tactical Sector 29 - Iron Outpost"
        self.world_tier: int = 6
        self.base_starting_credits: int = 980
        self.base_starting_energy: int = 245
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 40):
            threat = round(20.0 + w * 12.5 + 29 * 3.5, 1)
            spawns = [
