"""
Campaign Mission Model 21: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission21DataModel:
    def __init__(self):
        self.mission_index: int = 21
        self.sector_name: str = "Tactical Sector 21 - Iron Outpost"
        self.world_tier: int = 5
        self.base_starting_credits: int = 820
        self.base_starting_energy: int = 205
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 32):
            threat = round(20.0 + w * 12.5 + 21 * 3.5, 1)
            spawns = [
