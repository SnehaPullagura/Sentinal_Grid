"""
Campaign Mission Model 15: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission15DataModel:
    def __init__(self):
        self.mission_index: int = 15
        self.sector_name: str = "Tactical Sector 15 - Iron Outpost"
        self.world_tier: int = 3
        self.base_starting_credits: int = 700
        self.base_starting_energy: int = 175
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 26):
            threat = round(20.0 + w * 12.5 + 15 * 3.5, 1)
            spawns = [
