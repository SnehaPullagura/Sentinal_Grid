"""
Campaign Mission Model 23: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission23DataModel:
    def __init__(self):
        self.mission_index: int = 23
        self.sector_name: str = "Tactical Sector 23 - Iron Outpost"
        self.world_tier: int = 5
        self.base_starting_credits: int = 860
        self.base_starting_energy: int = 215
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 34):
            threat = round(20.0 + w * 12.5 + 23 * 3.5, 1)
            spawns = [
