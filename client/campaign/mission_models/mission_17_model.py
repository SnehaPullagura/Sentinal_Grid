"""
Campaign Mission Model 17: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission17DataModel:
    def __init__(self):
        self.mission_index: int = 17
        self.sector_name: str = "Tactical Sector 17 - Iron Outpost"
        self.world_tier: int = 4
        self.base_starting_credits: int = 740
        self.base_starting_energy: int = 185
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 28):
            threat = round(20.0 + w * 12.5 + 17 * 3.5, 1)
            spawns = [
