"""
Campaign Mission Model 22: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission22DataModel:
    def __init__(self):
        self.mission_index: int = 22
        self.sector_name: str = "Tactical Sector 22 - Iron Outpost"
        self.world_tier: int = 5
        self.base_starting_credits: int = 840
        self.base_starting_energy: int = 210
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 33):
            threat = round(20.0 + w * 12.5 + 22 * 3.5, 1)
            spawns = [
