"""
Campaign Mission Model 26: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission26DataModel:
    def __init__(self):
        self.mission_index: int = 26
        self.sector_name: str = "Tactical Sector 26 - Iron Outpost"
        self.world_tier: int = 6
        self.base_starting_credits: int = 920
        self.base_starting_energy: int = 230
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 37):
            threat = round(20.0 + w * 12.5 + 26 * 3.5, 1)
            spawns = [
