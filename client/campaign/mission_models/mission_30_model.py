"""
Campaign Mission Model 30: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission30DataModel:
    def __init__(self):
        self.mission_index: int = 30
        self.sector_name: str = "Tactical Sector 30 - Iron Outpost"
        self.world_tier: int = 6
        self.base_starting_credits: int = 1000
        self.base_starting_energy: int = 250
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 41):
            threat = round(20.0 + w * 12.5 + 30 * 3.5, 1)
            spawns = [
