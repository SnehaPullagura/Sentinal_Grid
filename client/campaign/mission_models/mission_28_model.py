"""
Campaign Mission Model 28: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission28DataModel:
    def __init__(self):
        self.mission_index: int = 28
        self.sector_name: str = "Tactical Sector 28 - Iron Outpost"
        self.world_tier: int = 6
        self.base_starting_credits: int = 960
        self.base_starting_energy: int = 240
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 39):
            threat = round(20.0 + w * 12.5 + 28 * 3.5, 1)
            spawns = [
