"""
Campaign Mission Model 25: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission25DataModel:
    def __init__(self):
        self.mission_index: int = 25
        self.sector_name: str = "Tactical Sector 25 - Iron Outpost"
        self.world_tier: int = 5
        self.base_starting_credits: int = 900
        self.base_starting_energy: int = 225
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 36):
            threat = round(20.0 + w * 12.5 + 25 * 3.5, 1)
            spawns = [
