"""
Campaign Mission Model 27: Tactical Scenario Data & Execution Pipeline.
"""
...
class Mission27DataModel:
    def __init__(self):
        self.mission_index: int = 27
        self.sector_name: str = "Tactical Sector 27 - Iron Outpost"
        self.world_tier: int = 6
        self.base_starting_credits: int = 940
        self.base_starting_energy: int = 235
        self.waves_data: Dict[int, SectorWaveConfig] = self._compile_waves()

    def _compile_waves(self) -> Dict[int, SectorWaveConfig]:
        waves = {}
        for w in range(1, 38):
            threat = round(20.0 + w * 12.5 + 27 * 3.5, 1)
            spawns = [
