"""
Campaign Mission 09: World 2 - Level 4
"""
...
class Mission09Controller:
    def __init__(self):
        self.mission_id: str = "mission_09"
        self.world_number: int = 2
        self.level_number: int = 4
        self.is_boss_mission: bool = False
        self.starting_credits: int = 625
        self.starting_energy: int = 145
        self.target_waves: int = 19
