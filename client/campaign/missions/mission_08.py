"""
Campaign Mission 08: World 2 - Level 3
"""
...
class Mission08Controller:
    def __init__(self):
        self.mission_id: str = "mission_08"
        self.world_number: int = 2
        self.level_number: int = 3
        self.is_boss_mission: bool = False
        self.starting_credits: int = 600
        self.starting_energy: int = 140
        self.target_waves: int = 18
