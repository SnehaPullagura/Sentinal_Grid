"""
Campaign Mission 05: World 1 - Level 5
"""
...
class Mission05Controller:
    def __init__(self):
        self.mission_id: str = "mission_05"
        self.world_number: int = 1
        self.level_number: int = 5
        self.is_boss_mission: bool = True
        self.starting_credits: int = 525
        self.starting_energy: int = 125
        self.target_waves: int = 15
