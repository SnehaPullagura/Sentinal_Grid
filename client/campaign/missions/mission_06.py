"""
Campaign Mission 06: World 2 - Level 1
"""
...
class Mission06Controller:
    def __init__(self):
        self.mission_id: str = "mission_06"
        self.world_number: int = 2
        self.level_number: int = 1
        self.is_boss_mission: bool = False
        self.starting_credits: int = 550
        self.starting_energy: int = 130
        self.target_waves: int = 16
