"""
Campaign Mission 19: World 4 - Level 4
...
class Mission19Controller:
    def __init__(self):
        self.mission_id: str = "mission_19"
        self.world_number: int = 4
        self.level_number: int = 4
        self.is_boss_mission: bool = False
        self.starting_credits: int = 880
        self.starting_energy: int = 215
        self.target_waves: int = 31
