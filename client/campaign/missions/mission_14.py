"""
Campaign Mission 14: World 3 - Level 4
"""
...
class Mission14Controller:
    def __init__(self):
        self.mission_id: str = "mission_14"
        self.world_number: int = 3
        self.level_number: int = 4
        self.is_boss_mission: bool = False
        self.starting_credits: int = 750
        self.starting_energy: int = 170
        self.target_waves: int = 24
