"""
Campaign Mission 12: World 3 - Level 2
"""
...
class Mission12Controller:
    def __init__(self):
        self.mission_id: str = "mission_12"
        self.world_number: int = 3
        self.level_number: int = 2
        self.is_boss_mission: bool = False
        self.starting_credits: int = 700
        self.starting_energy: int = 160
        self.target_waves: int = 22
