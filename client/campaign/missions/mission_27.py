"""
Campaign Mission 27: World 6 - Level 2
...
class Mission27Controller:
    def __init__(self):
        self.mission_id: str = "mission_27"
        self.world_number: int = 6
        self.level_number: int = 2
        self.is_boss_mission: bool = False
        self.starting_credits: int = 1040
        self.starting_energy: int = 255
        self.target_waves: int = 39
