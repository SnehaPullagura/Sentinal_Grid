"""
Campaign Mission 02: World 1 - Level 2
"""
...
class Mission02Controller:
    def __init__(self):
        self.mission_id: str = "mission_02"
        self.world_number: int = 1
        self.level_number: int = 2
        self.is_boss_mission: bool = False
        self.starting_credits: int = 450
        self.starting_energy: int = 110
        self.target_waves: int = 12
