"""
Campaign Mission 18: World 4 - Level 3
...
class Mission18Controller:
    def __init__(self):
        self.mission_id: str = "mission_18"
        self.world_number: int = 4
        self.level_number: int = 3
        self.is_boss_mission: bool = False
        self.starting_credits: int = 860
        self.starting_energy: int = 210
        self.target_waves: int = 30
