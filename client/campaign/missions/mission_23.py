"""
Campaign Mission 23: World 5 - Level 3
...
class Mission23Controller:
    def __init__(self):
        self.mission_id: str = "mission_23"
        self.world_number: int = 5
        self.level_number: int = 3
        self.is_boss_mission: bool = False
        self.starting_credits: int = 960
        self.starting_energy: int = 235
        self.target_waves: int = 35
