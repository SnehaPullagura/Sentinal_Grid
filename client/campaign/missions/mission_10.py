"""
Campaign Mission 10: World 2 - Level 5
"""
...
class Mission10Controller:
    def __init__(self):
        self.mission_id: str = "mission_10"
        self.world_number: int = 2
        self.level_number: int = 5
        self.is_boss_mission: bool = True
        self.starting_credits: int = 650
        self.starting_energy: int = 150
        self.target_waves: int = 20
