"""
Campaign Mission 03: World 1 - Level 3
"""
...
class Mission03Controller:
    def __init__(self):
        self.mission_id: str = "mission_03"
        self.world_number: int = 1
        self.level_number: int = 3
        self.is_boss_mission: bool = False
        self.starting_credits: int = 475
        self.starting_energy: int = 115
        self.target_waves: int = 13
