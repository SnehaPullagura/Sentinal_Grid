"""
Campaign Mission 25: World 5 - Level 5
...
class Mission25Controller:
    def __init__(self):
        self.mission_id: str = "mission_25"
        self.world_number: int = 5
        self.level_number: int = 5
        self.is_boss_mission: bool = True
        self.starting_credits: int = 1000
        self.starting_energy: int = 245
        self.target_waves: int = 37
