"""
Campaign Mission 07: World 2 - Level 2
"""
...
class Mission07Controller:
    def __init__(self):
        self.mission_id: str = "mission_07"
        self.world_number: int = 2
        self.level_number: int = 2
        self.is_boss_mission: bool = False
        self.starting_credits: int = 575
        self.starting_energy: int = 135
        self.target_waves: int = 17
