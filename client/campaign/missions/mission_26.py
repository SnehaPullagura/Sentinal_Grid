"""
Campaign Mission 26: World 6 - Level 1
...
class Mission26Controller:
    def __init__(self):
        self.mission_id: str = "mission_26"
        self.world_number: int = 6
        self.level_number: int = 1
        self.is_boss_mission: bool = False
        self.starting_credits: int = 1020
        self.starting_energy: int = 250
        self.target_waves: int = 38
