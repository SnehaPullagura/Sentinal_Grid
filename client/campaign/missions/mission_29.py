"""
Campaign Mission 29: World 6 - Level 4
...
class Mission29Controller:
    def __init__(self):
        self.mission_id: str = "mission_29"
        self.world_number: int = 6
        self.level_number: int = 4
        self.is_boss_mission: bool = False
        self.starting_credits: int = 1080
        self.starting_energy: int = 265
        self.target_waves: int = 41
