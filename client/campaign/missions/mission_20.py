"""
Campaign Mission 20: World 4 - Level 5
...
class Mission20Controller:
    def __init__(self):
        self.mission_id: str = "mission_20"
        self.world_number: int = 4
        self.level_number: int = 5
        self.is_boss_mission: bool = True
        self.starting_credits: int = 900
        self.starting_energy: int = 220
        self.target_waves: int = 32
