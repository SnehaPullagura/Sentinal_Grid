"""
Campaign Mission 22: World 5 - Level 2
...
class Mission22Controller:
    def __init__(self):
        self.mission_id: str = "mission_22"
        self.world_number: int = 5
        self.level_number: int = 2
        self.is_boss_mission: bool = False
        self.starting_credits: int = 940
        self.starting_energy: int = 230
        self.target_waves: int = 34
