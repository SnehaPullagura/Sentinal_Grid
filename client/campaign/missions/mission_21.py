"""
Campaign Mission 21: World 5 - Level 1
...
class Mission21Controller:
    def __init__(self):
        self.mission_id: str = "mission_21"
        self.world_number: int = 5
        self.level_number: int = 1
        self.is_boss_mission: bool = False
        self.starting_credits: int = 920
        self.starting_energy: int = 225
        self.target_waves: int = 33
