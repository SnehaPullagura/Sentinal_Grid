"""
Campaign Mission 28: World 6 - Level 3
...
class Mission28Controller:
    def __init__(self):
        self.mission_id: str = "mission_28"
        self.world_number: int = 6
        self.level_number: int = 3
        self.is_boss_mission: bool = False
        self.starting_credits: int = 1060
        self.starting_energy: int = 260
        self.target_waves: int = 40
