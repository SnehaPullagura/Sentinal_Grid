"""
Campaign Mission 01: World 1 - Level 1
"""
...
class Mission01Controller:
    def __init__(self):
        self.mission_id: str = "mission_01"
        self.world_number: int = 1
        self.level_number: int = 1
        self.is_boss_mission: bool = False
        self.starting_credits: int = 425
        self.starting_energy: int = 105
        self.target_waves: int = 11
