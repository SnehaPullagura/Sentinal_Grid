"""
Campaign Mission 17: World 4 - Level 2
...
class Mission17Controller:
    def __init__(self):
        self.mission_id: str = "mission_17"
        self.world_number: int = 4
        self.level_number: int = 2
        self.is_boss_mission: bool = False
        self.starting_credits: int = 840
        self.starting_energy: int = 205
        self.target_waves: int = 29
