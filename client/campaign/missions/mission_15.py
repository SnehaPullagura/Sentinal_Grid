"""
Campaign Mission 15: World 3 - Level 5
"""
...
class Mission15Controller:
    def __init__(self):
        self.mission_id: str = "mission_15"
        self.world_number: int = 3
        self.level_number: int = 5
        self.is_boss_mission: bool = True
        self.starting_credits: int = 775
        self.starting_energy: int = 175
        self.target_waves: int = 25
