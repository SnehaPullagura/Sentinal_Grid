"""
Campaign Mission 11: World 3 - Level 1
"""
...
class Mission11Controller:
    def __init__(self):
        self.mission_id: str = "mission_11"
        self.world_number: int = 3
        self.level_number: int = 1
        self.is_boss_mission: bool = False
        self.starting_credits: int = 675
        self.starting_energy: int = 155
        self.target_waves: int = 21
