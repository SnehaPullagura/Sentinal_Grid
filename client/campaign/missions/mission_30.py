"""
Campaign Mission 30: World 6 - Level 5
[APEX CLIMAX BOSS] World Stronghold
"""
...
class Mission30Controller:
    def __init__(self):
        self.mission_id: str = "mission_30"
        self.world_number: int = 6
        self.level_number: int = 5
        self.is_boss_mission: bool = True
        self.starting_credits: int = 1100
        self.starting_energy: int = 270
        self.target_waves: int = 42
