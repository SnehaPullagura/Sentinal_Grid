"""
Campaign Sector 25 Narrative Briefing & Tactical Logbook.
World 5 - Operation Stage 5
"""
...
class Sector25IntelLog:
    @staticmethod
    def get_intel_briefing() -> List[TacticalIntelEntry]:
        return [
            TacticalIntelEntry(
                entry_id="INTEL_25_A",
                timestamp_stardate="SD 4280.300.4",
                classification_level="RESTRICTED // COMMAND EYES ONLY",
                officer="Admiral Sonya Cross",
                transcript="Forward scouting probes detect massive cybernetic armada gathering in Sector 25. Sentinel grid grid-lock protocol authorized."
            ),
            TacticalIntelEntry(
                entry_id="INTEL_25_B",
                timestamp_stardate="SD 4280.300.6",
