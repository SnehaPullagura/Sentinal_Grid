"""
Campaign Sector 27 Narrative Briefing & Tactical Logbook.
World 6 - Operation Stage 2
"""
...
class Sector27IntelLog:
    @staticmethod
    def get_intel_briefing() -> List[TacticalIntelEntry]:
        return [
            TacticalIntelEntry(
                entry_id="INTEL_27_A",
                timestamp_stardate="SD 4280.324.4",
                classification_level="RESTRICTED // COMMAND EYES ONLY",
                officer="Admiral Sonya Cross",
                transcript="Forward scouting probes detect massive cybernetic armada gathering in Sector 27. Sentinel grid grid-lock protocol authorized."
            ),
            TacticalIntelEntry(
                entry_id="INTEL_27_B",
                timestamp_stardate="SD 4280.324.6",
