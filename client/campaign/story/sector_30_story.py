"""
Campaign Sector 30 Narrative Briefing & Tactical Logbook.
World 6 - Operation Stage 5
"""
...
class Sector30IntelLog:
    @staticmethod
    def get_intel_briefing() -> List[TacticalIntelEntry]:
        return [
            TacticalIntelEntry(
                entry_id="INTEL_30_A",
                timestamp_stardate="SD 4280.360.4",
                classification_level="RESTRICTED // COMMAND EYES ONLY",
                officer="Admiral Sonya Cross",
                transcript="Forward scouting probes detect massive cybernetic armada gathering in Sector 30. Sentinel grid grid-lock protocol authorized."
            ),
            TacticalIntelEntry(
                entry_id="INTEL_30_B",
                timestamp_stardate="SD 4280.360.6",
