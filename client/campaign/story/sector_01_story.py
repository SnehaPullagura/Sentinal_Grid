"""
Campaign Sector 01 Narrative Briefing & Tactical Logbook.
World 1 - Operation Stage 1
"""
...
class Sector01IntelLog:
    @staticmethod
    def get_intel_briefing() -> List[TacticalIntelEntry]:
        return [
            TacticalIntelEntry(
                entry_id="INTEL_01_A",
                timestamp_stardate="SD 4280.12.4",
                classification_level="RESTRICTED // COMMAND EYES ONLY",
                officer="Admiral Sonya Cross",
                transcript="Forward scouting probes detect massive cybernetic armada gathering in Sector 01. Sentinel grid grid-lock protocol authorized."
            ),
            TacticalIntelEntry(
                entry_id="INTEL_01_B",
                timestamp_stardate="SD 4280.12.6",
