"""
Sector 30 Victory Condition & Star Rating Engine.
"""
...
class Sector30VictoryEvaluator:
    def __init__(self):
        self.sector_id: str = "sector_30"
        self.flawless_hp_threshold: float = 95.0
    ...
    def evaluate_victory(self, hp_pct: float, time_sec: float, spent_credits: int) -> SectorStarRating:
        ...
        is_speed = time_sec <= (300.0 + 300)
        is_budget = spent_credits <= (2500 + 4500)
