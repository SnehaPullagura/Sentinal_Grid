"""
Sector 23 Victory Condition & Star Rating Engine.
"""
...
class Sector23VictoryEvaluator:
    def __init__(self):
        self.sector_id: str = "sector_23"
        self.flawless_hp_threshold: float = 92.0
    ...
    def evaluate_victory(self, hp_pct: float, time_sec: float, spent_credits: int) -> SectorStarRating:
        ...
        is_speed = time_sec <= (300.0 + 230)
        is_budget = spent_credits <= (2500 + 3450)
