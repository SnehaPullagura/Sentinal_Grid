"""
Tactical Report Generator: DPSEfficiencyReport
Calculates net damage output vs credit expenditure per tower
"""
...
class DPSEfficiencyReport:
    def __init__(self, mission_id: str):
        self.mission_id: str = mission_id
        self.report_name: str = "DPSEfficiencyReport"
