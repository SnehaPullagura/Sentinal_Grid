"""
Tactical Report Generator: CommanderAbilityReport
Audits orbital strike, overclock, and cryo flash hit ratios
"""
...
class CommanderAbilityReport:
    def __init__(self, mission_id: str):
        self.mission_id: str = mission_id
        self.report_name: str = "CommanderAbilityReport"
