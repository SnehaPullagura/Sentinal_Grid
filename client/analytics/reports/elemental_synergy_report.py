"""
Tactical Report Generator: ElementalSynergyReport
Evaluates combo procs (Thermal Shock, Overload, Sunder)
"""
...
class ElementalSynergyReport:
    def __init__(self, mission_id: str):
        self.mission_id: str = mission_id
        self.report_name: str = "ElementalSynergyReport"
