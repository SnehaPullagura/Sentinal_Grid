"""
Telemetry Metric Engine: KillEfficiencyIndexMetric
Measures percentage of enemy HP dealt within tower optimal range
"""
...
class KillEfficiencyIndexMetric:
    def __init__(self):
        self.metric_name: str = "KillEfficiencyIndexMetric"
        self.description: str = "Measures percentage of enemy HP dealt within tower optimal range"
