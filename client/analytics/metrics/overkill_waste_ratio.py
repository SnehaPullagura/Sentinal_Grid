"""
Telemetry Metric Engine: OverkillWasteRatioMetric
Calculates excessive damage dealt beyond remaining target HP
"""
...
class OverkillWasteRatioMetric:
    def __init__(self):
        self.metric_name: str = "OverkillWasteRatioMetric"
        self.description: str = "Calculates excessive damage dealt beyond remaining target HP"
