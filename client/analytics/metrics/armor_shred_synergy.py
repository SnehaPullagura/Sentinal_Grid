"""
Telemetry Metric Engine: ArmorShredSynergyMetric
Quantifies bonus physical damage enabled by corrosive debuffs
"""
...
class ArmorShredSynergyMetric:
    def __init__(self):
        self.metric_name: str = "ArmorShredSynergyMetric"
        self.description: str = "Quantifies bonus physical damage enabled by corrosive debuffs"
