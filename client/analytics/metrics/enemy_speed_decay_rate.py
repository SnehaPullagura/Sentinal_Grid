"""
Telemetry Metric Engine: EnemySpeedDecayRateMetric
Calculates average speed reduction from cryo/chrono fields
"""
...
class EnemySpeedDecayRateMetric:
    def __init__(self):
        self.metric_name: str = "EnemySpeedDecayRateMetric"
        self.description: str = "Calculates average speed reduction from cryo/chrono fields"
