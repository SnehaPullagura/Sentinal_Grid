"""
Telemetry Metric Engine: ReactionTimeEvaluatorMetric
Logs latency between enemy wave spawn and player defensive adaptations
"""
...
class ReactionTimeEvaluatorMetric:
    def __init__(self):
        self.metric_name: str = "ReactionTimeEvaluatorMetric"
        self.description: str = "Logs latency between enemy wave spawn and player defensive adaptations"
